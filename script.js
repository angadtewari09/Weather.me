var temp, maxtemp, mintemp, desc, wind, hum, main, day, night, target=0;
var x = [
    "clear sky",
    "few clouds",
    "scattered clouds",
...
function weather(input) {
    ...
    .then(function(data) {
        ...
        //alert(temperature);
        //feels like section to be added
        ...
        document.querySelector("#feels_like").innerHTML = Math.round(data.main.feels_like) + "&deg; C";
